                ...
                <form action="" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" id="discount_percent" name="discount_percent" value="<?= $promotion['discount_percent'] ?>" min="0" max="100">
                        </div>
                        <div class="col-md-3">
                            <label for="discount_amount" class="form-label">Giảm (VNĐ)</label>
                            <input type="number" class="form-control" id="discount_amount" name="discount_amount" value="<?= $promotion['discount_amount'] ?>" min="0">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="is_active" name="is_active">
                                <option value="1" <?= $promotion['is_active'] == 1 ? 'selected' : '' ?>>Kích hoạt</option>
                                <option value="0" <?= $promotion['is_active'] == 0 ? 'selected' : '' ?>>Vô hiệu hóa</option>
                            </select>
                        </div>
                    </div>
